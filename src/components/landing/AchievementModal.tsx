        ...
        <div className="flex-1 p-8 md:p-12 overflow-y-auto scrollbar-thin">
          <div className="space-y-10">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  ...
                  <p className="text-sm font-black text-slate-800">{achievement.tahun}</p>
                </div>
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  <div className="flex items-center gap-2 text-slate-400 mb-1.5">
                    <Bookmark size={14} />
            ...
            <div className="pt-8 flex">
              <button className="w-full btn-primary justify-center py-4 rounded-2xl shadow-xl shadow-indigo-600/20 text-xs uppercase tracking-widest font-black">
                <Share2 size={16} />
                Bagikan Prestasi
              </button>
            </div>
